...
smoothScatter(fwd[,3],fwd[,4],main="Forward strand",xlab="WGBS M-Levels",ylab="Nanopore M-level")
smoothScatter(rev[,3],rev[,4],main="Forward reverse",xlab="WGBS M-Levels",ylab="Nanopore M-level")
